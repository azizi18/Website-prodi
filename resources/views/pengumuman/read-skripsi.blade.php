...
@section('content')
    <section id="pengumuman" class="isi-mahasiswa">
        <div class="container">
            <p class="mt-5"> <?php echo $read_skripsi->nama; ?>| <?php echo date('M d Y ', strtotime($read_skripsi->tanggal_publish)); ?>
                | <?php echo $read_skripsi->jenis_skripsi; ?></p>
            <div class="pengumuman" href="#faq1">

                    <h3 class="fw-bold"><i class="bi bi-file-earmark-text-fill icon-camera"> </i><?php echo $read_skripsi->judul_skripsi; ?> </h4>
               
            </div>
            <div id="content">
                <embed src="{{ asset('assets/upload/file/'.$read_skripsi->file) }}" type="application/pdf" width="100%" height="600px" />
                <div class="btn-berkas -mt-4">
                    <p><?php echo $read_skripsi->judul_skripsi; ?></p>
                <p class="btn-download"><a href="{{ asset('skripsi/unduh/'.$read_skripsi->id_skripsi) }}"> <span>Download</span></a></p>
              </div>
            <h6><?php echo $read_skripsi->isi; ?></h6>
        ...
        <?php foreach($related_post as $related_post) { ?>
            <?php if($related_post->status_skripsi=="Publish") { ?>

        <div class="col-lg-4 mt-4">
            <div class="pengumuman" href="#faq1">
                <a href="{{ asset('pengumuman/read-skripsi/' . $related_post->slug_skripsi) }}">
                    <div class="fw-bold"><?php echo $related_post->judul_skripsi; ?>
                    </div>
                </a>
            </div>
