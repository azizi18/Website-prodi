...
<form action="{{ asset('admin/skripsi/tambah_proses') }}" method="post" enctype="multipart/form-data"
    ...
    <div class="row form-group">
        ...
        <div class="col-md-3">
            <select name="status_skripsi" class="form-control select2" id="selectoption">
    ...
    <div class="row form-group">
        ...
        <div class="col-md-6">
            <input type="text" name="judul_skripsi" class="form-control form-control-lg"
                placeholder="Judul <?php if (isset($_GET['jenis_skripsi'])) {
                    echo $_GET['jenis_skripsi'];
                } else {
                    echo 'Skripsi';
                } ?>" required="required" value="{{ old('judul_skripsi') }}">
        </div>
    </div>
    <?php if(isset($_GET['jenis_skripsi'])) { ?>
    <input type="hidden" name="jenis_skripsi" value="<?php echo $_GET['jenis_skripsi']; ?>">
    ...
    <input type="hidden" name="jenis_skripsi" value="Berita">
    <?php } ?>

    <div class="row form-group">
        <label class="col-md-3 text-right">Upload File</label>
        <div class="col-md-9">
            <input type="file" name="file" class="form-control" required="required" placeholder="Upload file">
    ...
    <div class="row form-group">
        ...
        <div class="col-md-9">
            <textarea name="isi" class="form-control" id="editor" placeholder="Isi skripsi">{{ old('isi') }}</textarea>
        </div>
    </div>
