...
<form action="{{ asset('admin/berkas/tambah_proses') }}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
{{ csrf_field() }}
...
<div class="row form-group">
    ...
    <div class="row form-group">
        ...
        <div class="col-md-9">
            <textarea name="isi" class="form-control" id="editor" placeholder="Isi berkas">{{ old('isi') }}</textarea>
        </div>
    </div>
