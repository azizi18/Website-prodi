<p class="text-right">
    <a href="{{ asset('admin/semester-enam') }}" class="btn btn-success btn-sm">
...
<form action="{{ asset('admin/semester-enam/edit_proses') }}" method="post" enctype="multipart/form-data"
