...
class Galeri_model extends Model
{
    ...
    public function semua()
    {
        $query = DB::table('galeri')
            ...
            ->select('galeri.*', 'galeri.judul_galeri', 'galeri.motto', 'galeri.gambar', 'galeri.isi', 'galeri.status_text', 'galeri.urutan')
    ...
    public function cari($keywords)
    {
        $query = DB::table('galeri')
            ...
            ->orWhere('galeri.judul_galeri', 'LIKE', "%{$keywords}%")
